...
import hr.algebra.movies.view.AuthNavScreen
import hr.algebra.movies.view.auth.AuthenticationScreen
                    ...
                    authenticationViewModel.login(
                        ...
                        onFail = {
                            Toast.makeText(context,
                                context.getString(R.string.unable_to_login), Toast.LENGTH_SHORT).show()
                        }
                    )
            ...
            AuthenticationScreen(
                ...
                onRegister = {
                    ...
                    authenticationViewModel.register(
                        ...
                        onFail = {
                            Toast.makeText(context,
                                context.getString(R.string.unable_to_register), Toast.LENGTH_SHORT).show()
                        }
                    )
                },
                authenticationState = authenticationViewModel.authenticationState.value,
